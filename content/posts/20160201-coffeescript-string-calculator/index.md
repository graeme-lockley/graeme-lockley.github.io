...
date: 2016-02-01
description: "Building a property-based testing framework from scratch in CoffeeScript using higher-order functions."
tags: ["coffeescript", "testing", "property-based-testing", "tdd"]
draft: false
---
...
Using the ideas that a generator is a function which, when invoked, will return a value, `nonNegativeIntegers` is defined as
