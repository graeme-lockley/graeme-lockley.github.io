...
Companies such as Apple, Microsoft, Google, and Meta were initially received as liberating forces. They promised wider access to information, lower barriers to creation, and more open forms of participation. Google's founding motto — *"Don't be evil"* — captured something real about that era's optimism. It was naive, perhaps, but it was also a sincere declaration that scale and conscience could coexist. In many respects, those early promises were not fraudulent. The early internet did widen access and reduce friction in ways that were genuinely emancipatory.
...
Economic concentration matters not only because it reduces competition, but because in digital systems it also governs what can be seen, prioritised, and believed. Once platforms intermediate search, discovery, distribution, and attention at scale, they begin to operate as epistemic infrastructure — and economic power becomes political power.

The [United Nations' Information Integrity initiative](https://www.un.org/en/information-integrity) argues that the modern information ecosystem is threatened by the unprecedented volume, velocity, and virality of misinformation, disinformation, and hate speech, and that new leaps in AI capability intensify those risks. The problem is not individual bad actors. It is systemic incentive design.
...
The AI wave intensifies all of this because it combines three scarce resources: talent, compute, and data. The [Stanford HAI AI Index 2026](https://hai.stanford.edu/ai-index) reports rapid technical progress, accelerating investment, and spreading adoption, while warning that governance, evaluation, and public understanding are lagging behind. It also notes that data transparency is declining precisely when independent measurement is becoming more important.

Frontier capability does not emerge in a flat landscape. It concentrates where capital markets, hyperscale infrastructure, semiconductor access, and elite research communities intersect. Innovation may be internationally sourced, but control over deployment, standards, and downstream economic value is increasingly held by a narrow set of companies and jurisdictions.
